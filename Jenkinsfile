pipeline {
    ...
    stages {
        stage("Clone Twilio SMS Sender API from Github") {
            steps {
                echo "Cloning Twilio SMS Sender API from Github. Please Wait..."
                git branch: 'main',
                    url: 'https://github.com/Elleined/twilio-sms-sender-api'
                echo "Cloning Twilio SMS Sender API from Github. Success!"
            }
        }
        ...
        stage("Push docker image to DockerHub") {
            steps {
                ...
                sh 'docker tag tssa:latest elleined/tssa:latest'
                sh 'docker push elleined/tssa:latest'
